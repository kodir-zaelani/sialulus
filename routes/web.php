...
//     });
    ...
    Route::get('/download', function(){
        $file = public_path()."/file_upload/templatedatalulus.xlsx";
        $headers = array(
            'Content-Type: application/xlsx',
        );
        return Response::download($file, "Template Kelulusan.xlsx", $headers); //Download file yang dicari berdasarkan nama file
    });
